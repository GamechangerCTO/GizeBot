...
class ImageGenerator {
  ...
  async generatePredictionImage(matches) {
    try {
      ...
      console.log('✅ AI image generated successfully (PNG, Medium Quality)');
  ...
  async generateLiveImage(liveMatches) {
    try {
      ...
      const imageBase64 = response.data[0].b64_json;
      console.log('✅ AI LIVE image generated successfully (PNG, Medium Quality)');
  ...
  async generateResultsImage(results) {
    try {
      ...
      const imageBase64 = response.data[0].b64_json;
      console.log('✅ AI results image generated successfully (PNG, Medium Quality)');
...
`;
      ...
      const imageBase64 = response.data[0].b64_json;
      console.log('✅ AI promo image generated successfully (PNG, Medium Quality)');
