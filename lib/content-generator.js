...
`;
  ...
  async generatePromoMessage(promoCode = 'gize251', bonusOffer = '100% Bonus') {
    try {
      const prompt = `
...
- Write EXACTLY 2-3 ULTRA-SHORT sentences
- Each sentence maximum 10-15 words
- Use "YOU" to make it personal
- Include SPECIFIC benefits and numbers ONLY
- Include the promo code prominently
- NO explanations, NO descriptions, NO stories
- Pure ACTION and BENEFITS only
- Be DIRECT and PUNCHY

CONTENT STYLE:
- Sharp and direct like a winning bet slip
- Numbers and percentages only
- NO extra words or fluff
- Example: "Grab 200% BONUS! Use WIN200! Triple your cash!"

MANDATORY LANGUAGE RULES:
- ENGLISH ONLY - NO EXCEPTIONS
- NO Amharic characters: ፉ, ት, ቦ, ል, ን, ስ, etc.
- Example: "200% BONUS! Code WIN200! Triple your money!"
`;
