...
1. 🎯 Opens with an exciting hook that grabs attention
2. 💰 Clearly explains the bonus value and benefits
3. 🚀 Creates genuine urgency (limited time/spots)
4. 📱 Simple, clear instructions on how to claim
5. 🔥 Strong emotional call-to-action
6. ✨ Uses strategic emojis (not overwhelming)
7. 🎲 Appeals to smart bettors who want to win big

STYLE REQUIREMENTS:
- Conversational and personal tone
- NO lines, dashes, or decorative separators
- Focus on BENEFITS, not just features
- Make it feel exclusive and premium
- Include the promo code naturally
- End with the website link

Write like you're personally inviting them to win big!
`;
      ...
      const response = await this.openai.chat.completions.create({
        ...
        messages: [
          {
            role: "system",
            content: "You are a premium sports betting marketing expert. Write ONLY in English. Create irresistible, conversational content that makes people excited to claim bonuses and win big. Be personal, urgent, and benefit-focused."
          },
          {
            role: "user",
            content: prompt
