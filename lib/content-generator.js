...
- Write 4-6 short punchy sentences
- Use "YOU" to make it personal
- NO lines, dashes, or decorative elements
- Focus on TRANSFORMATION (what they'll achieve)
- Make them feel like a VIP
- Include the promo code as the KEY to success
- Skip website link (handled by buttons)
- End with excitement and anticipation

Write like you're revealing a secret winning strategy to a close friend!

LANGUAGE REQUIREMENT: 
- Write EXCLUSIVELY in English language
- NO Amharic text allowed
...
`;
      ...
      const response = await this.openai.chat.completions.create({
        ...
        messages: [
          {
            role: "system",
            content: "You are a premium sports betting marketing expert. CRITICAL: Write ONLY in English language, NEVER in Amharic or any other language. Create irresistible, conversational content that makes people excited to claim bonuses and win big. Be personal, urgent, and benefit-focused. ALWAYS use English words and English text only."
          },
          {
            role: "user",
            content: prompt
