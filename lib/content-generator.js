...
5. Use engaging emojis
6. Include the website ${this.websiteUrl}
7. DO NOT use any lines, dashes, or separators in the text
8. Keep the content clean without any decorative lines

Make this motivating and exciting for betting enthusiasts without any line separators.
`;
