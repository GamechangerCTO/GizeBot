...
class GizeBetsScheduler {
  ...
  async sendScheduledPromo(timeSlot) {
    try {
      ...
      const promoCodes = {
        morning: { code: 'MORNING100', offer: '100% Morning Boost Bonus' },
        afternoon: { code: 'POWER200', offer: '200% Power Hour Bonus' },
        evening: { code: 'NIGHT250', offer: '250% Night Winner Bonus' }
      };
