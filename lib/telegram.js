  ...
  createPredictionsKeyboard() {
    return [
      [
        {
          text: '⚽ Football',
          url: this.createTrackingUrl('https://gizebets.et/league?sportId=0', 'predictions_football')
        },
        {
          text: '🔴 Live Football',
      ...
      [
        {
          text: '🎁 Enter Coupon',
          url: this.createTrackingUrl('https://gizebets.et/promo-campaigns', 'predictions_promo')
        }
      ]
    ];
  }
  ...
  createResultsKeyboard() {
    return [
      [
        {
          text: '⚽ Football',
          url: this.createTrackingUrl('https://gizebets.et/league?sportId=0', 'results_football')
        },
        {
          text: '🔴 Live Football',
      ...
      [
        {
          text: '🎁 Enter Coupon',
          url: this.createTrackingUrl('https://gizebets.et/promo-campaigns', 'results_promo')
        }
      ]
    ];
  }
  ...
  createPromoKeyboard(promoCode) {
    return [
      ...
      [
        {
          text: '⚽ Football',
          url: this.createTrackingUrl('https://gizebets.et/league?sportId=0', 'promo_football')
        },
        {
          text: '🔴 Live Football',
