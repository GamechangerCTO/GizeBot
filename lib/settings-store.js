...
const DEFAULT_SETTINGS = {
  buttons: {
    default: [
      { text: '⚽ Football', url: 'https://gizebets.et/league?sportId=0' },
      { text: '🔴 Live Football', url: 'https://gizebets.et/live' },
      { text: '🎁 Enter Coupon', url: 'https://gizebets.et/promo-campaigns', couponCode: 'gize251', offer: '100 ETB Bonus' }
    ],
    overrideOnce: null // same shape as default; consumed on first use
  },
  coupon: {
    default: { code: 'gize251', offer: '100 ETB Bonus' },
